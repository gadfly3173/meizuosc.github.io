...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = '\n    ' + _icons.heart + '\n    ' + (likedReaction ? '取消' : '点赞') + '\n    ' + (meta.reactions && meta.reactions.heart ? ' \u2022 已获得  <strong>' + meta.reactions.heart + '</strong>  个赞' : '') + '\n  ';
...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    emptyBlock.innerText = '还没有评论呢┑(￣Д ￣)┍  快来写下第一条评论吧！';
...
function renderEditor(_ref3, instance) {
  ...
  container.innerHTML = '\n      ' + (user.login ? '<a class="gitment-editor-avatar" href="' + user.html_url + '" target="_blank">\n            <img class="gitment-editor-avatar-img" src="' + user.avatar_url + '"/>\n          </a>' : user.isLoggingIn ? '<div class="gitment-editor-avatar">' + _icons.spinner + '</div>' : '<a class="gitment-editor-avatar" href="' + instance.loginLink + '" title="使用GitHub账号登录">\n              ' + _icons.github + '\n            </a>') + '\n    </a>\n    <div class="gitment-editor-main">\n      <div class="gitment-editor-header">\n        <nav class="gitment-editor-tabs">\n          <button class="gitment-editor-tab gitment-selected" role="tab" aria-selected="true">撰写</button>\n          <button class="gitment-editor-tab gitment-selected" role="tab" aria-selected="true">预览</button>\n        </nav>\n        <div class="gitment-editor-login">\n          ' + (user.login ? '<a class="gitment-editor-logout-link">退出登录</a>' : user.isLoggingIn ? '正在登录' : '使用GitHub账号<a class="gitment-editor-login-link" href="' + instance.loginLink + '">登录</a>') + '\n        </div>\n      </div>\n      <div class="gitment-editor-body">\n        <div class="gitment-editor-write-field">\n          <textarea placeholder="写点什么吧(´･ω･`)" title="' + disabledTip + '" ' + shouldDisable + '></textarea>\n        </div>\n        <div class="gitment-editor-preview-field gitment-hidden">\n          <div class="gitment-editor-preview gitment-markdown"></div>\n        </div>\n      </div>\n    </div>\n    <div class="gitment-editor-footer">\n      <a class="gitment-editor-footer-tip" href="https://guides.github.com/features/mastering-markdown/" target="_blank">\n        支持使用Markdown语言\n      </a>\n      <button class="gitment-editor-submit" title="' + disabledTip + '" ' + shouldDisable + '>评论</button>\n    </div>\n  ';
  if (user.login) {
  ...
  previewTab.onclick = function () {
    ...
    if (!content) {
      preview.innerText = '你还没写呢(⊙o⊙)';
      return;
    }

    preview.innerText = '加载预览中((*゜Д゜)ゞ”';
  ...
  submitButton.onclick = function () {
    submitButton.innerText = '提交中_(:з」∠)_';
